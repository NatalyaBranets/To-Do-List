...
public class GlobalExceptionHandler {
    ...
    public ModelAndView accessForbiddenExceptionHandler(HttpServletResponse response, HttpServletRequest request, AccessDeniedException exception) throws IOException {
